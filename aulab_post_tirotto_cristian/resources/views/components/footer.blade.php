<!-- Footer -->
<footer class="bg-light text-center bg-body-tertiary ">
  <!-- Grid container -->
  <div class="container p-4 ">
    ...
    <section class="mb-4">
      ...
      <!-- Linkedin -->
      <a class="btn btn-primary btn-floating m-1" style="background-color: #0082ca" href="#!" role="button"><i class="fa-brands fa-linkedin-in"></i></a>
      <!-- Github -->
